    ...
    <header className="relative z-10">
      <div className="mx-auto flex max-w-5xl items-center justify-between gap-4 px-6 py-7">
        <div className="flex flex-col">
          <span className="font-display font-medium text-[2.75rem] italic leading-none tracking-tight text-paper">
            Domicile
          </span>
          <span className="mt-2 font-display font-medium text-[1.15rem] italic leading-tight text-paper">
